...
def _build_run_config(sources: list[dict], run_name: str, run_dir: Path) -> dict:
    ...
    runtime_keys = [
        ...
        "shared_service_idle_grace_sec",
        "vehicle_service_restart_limit",
        "vehicle_service_restart_backoff_sec",
        "vehicle_service_restart_max_backoff_sec",
        "fight_service_restart_limit",
        "fight_service_restart_backoff_sec",
        "fight_service_restart_max_backoff_sec",
