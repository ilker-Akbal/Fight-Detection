...
# Yerelde uygulama doğrudan http://127.0.0.1:8000/ altında çalışır.
URL_PREFIX = ""
...
PIPELINE_DEFAULTS = {
    ...
    "shared_service_idle_grace_sec": float(os.getenv("SHARED_SERVICE_IDLE_GRACE_SEC", "5")),
    "vehicle_service_restart_limit": int(os.getenv("VEHICLE_SERVICE_RESTART_LIMIT", "3")),
    "vehicle_service_restart_backoff_sec": float(os.getenv("VEHICLE_SERVICE_RESTART_BACKOFF_SEC", "2")),
    "vehicle_service_restart_max_backoff_sec": float(os.getenv("VEHICLE_SERVICE_RESTART_MAX_BACKOFF_SEC", "30")),
    "fight_service_restart_limit": int(os.getenv("FIGHT_SERVICE_RESTART_LIMIT", "3")),
    "fight_service_restart_backoff_sec": float(os.getenv("FIGHT_SERVICE_RESTART_BACKOFF_SEC", "2")),
    "fight_service_restart_max_backoff_sec": float(os.getenv("FIGHT_SERVICE_RESTART_MAX_BACKOFF_SEC", "30")),
